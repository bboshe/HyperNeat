# this file contains tools to convert controller outputs
...
# forces left or right / up or down press
def create_map_force():
    am = ACTION_MEANING
    inv_map = {v: k for k, v in am.items()}
    out = {}
    for x in perms(3):
...
CONTROLLER_TO_ACTION_FORCE = create_map_force()
...
#
#CONTROLLER_TO_ACTION_FORCE = {(False, False, False): 9,
#                              (False, False, True): 17,
#                              (False, True, False): 7,
#                              (False, True, True): 15,
#
